      ...
      <div className="about__container _container">
        ...
        <div className="about__body">
          <div className="about__column-left column-left">
            <div className="column-left__title">Здравствуйте!<br /> я ваш домашний <span>кондитер Ольга!</span></div>
            ...
            <div className="column-left__text-row">
              <div className="column-left__text-col">
                <h4>Поскольку меня всегда привлекало кондитерское дело, я решила приобрести знания и опыт в данной профессии. И уже в 2020 году закончила свои первые курсы! Влюбившись в своё дело окончательно, начала развивать страничку в социальных сетях. С тех пор я ничуть не пожалела о том что так круто всё поменяла! Меня часто называют «Богиня медовиков». И вовсе не зря, ведь я очень люблю эту начинку.  Она, для меня, связана с воспоминаниями из детства.</h4>
              </div>
              <div className="column-left__text-col">
                <h4>На данный момент в моём арсенале более 20 отработанных начинок.
                  Я всегда помогу Вам определиться с их выбором, а так же и с выбором декора. Ко мне обращаются люди за вкусными и запоминающимися тортами на любое ваше торжество.
          ...
          <div className="column-right__separator"></div>
            <div className="column-right__subtitle">В 2012 году закончила БНТУ по специальности инженер-строитель автомобильных дорог. Пройдя все ступени карьерной лестницы, поняла, что это не то о чём я мечтала! Проработав 9 лет по специальности, вот так, с легким сердцем я уволилась с должности начальника.</div>
